...
return [
    ...
    "sub_fields" => [
        ...
        [
            "key" => "crafted_layout_property_local_amenities_label",
            "name" => "local_amenities_label",
            "label" => "Local Amenities Label",
            "type" => "text",
            "required" => 0,
        ],
        [
            "key" => "crafted_layout_property_local_amenities",
            ...
            "sub_fields" => [
                [
                    "key" => "crafted_layout_property_amenity_category_icon",
                    "name" => "amenity_category_icon",
                    "label" => "Category Icon",
                    "type" => "text",
                    "required" => 0,
                    "wrapper" => [
                ...
                [
                    "key" => "crafted_layout_property_amenity_category_label",
                    "name" => "amenity_category_label",
                ...
                [
                    "key" => "crafted_layout_property_amenity_items",
                    "name" => "amenity_items",
                    "label" => "Items",
                    "type" => "repeater",
                    "required" => 0,
                    ...
                    "sub_fields" => [
                        [
                            "key" => "crafted_layout_property_amenity_name",
                            "name" => "amenity_name",
                            "label" => "Name",
                            "type" => "text",
                            "required" => 0,
                        ...
                        [
                            "key" => "crafted_layout_property_amenity_distance",
